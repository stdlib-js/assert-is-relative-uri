...
```javascript
import isRelativeURI from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-relative-uri@v0.2.2-esm/index.mjs';
```
...
[@stdlib/assert/is-uri]: https://github.com/stdlib-js/assert-is-uri/tree/esm
